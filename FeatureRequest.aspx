                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:Table ID="Table8" runat="server" HorizontalAlign="Center" Width="35%">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        ...
                                        <%--                                        <telerik:RadTextBox ID="txtHaveSmallShop" DisplayText="Instagram Username?" runat="server" Visible="false"></telerik:RadTextBox>--%>
                                        <%--<telerik:RadButton ID="chkHaveSmallShop" runat="server" Text="Yes?" ToggleType="CheckBox" ButtonType="ToggleButton" OnClientCheckedChanged="ShowHideWindow" AutoPostBack="false"></telerik:RadButton>--%>
                                        <telerik:RadTextBox ID="txtHaveSmallShop" DisplayText="Instagram Username?" runat="server" Visible="false"></telerik:RadTextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow Height="25px">
                            ...
                            <div align="center">
                                ...
                                <br />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please enter valid PayPal e-mail address" ValidationExpression="^[\w\.\-]+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]{1,})*(\.[a-zA-Z]{2,3}){1,2}$" ControlToValidate="txtPayPalEmail" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
